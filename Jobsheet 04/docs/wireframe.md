...
Latihan 2: User Flow Monitoring Peminjaman Terlambat (Aktor: Petugas)
...
Latihan 3: Identifikasi Edge Case Tambahan
1. Batas Maksimal Pinjam: Apa yang terjadi kalau seorang anggota mencoba meminjam 4 buku, padahal aturan perpustakaan membatasi maksimal hanya 3 buku per anggota? (Sistem harus menolak form dan memunculkan pesan error).
2. Buku Rusak/Hilang: Saat alur "Pengembalian", bagaimana kalau buku dikembalikan tapi dalam keadaan robek atau hilang? (Perlu ada opsi status "Rusak/Hilang" selain "Dikembalikan", dan stok buku normal tidak boleh bertambah).
3. Penyusupan URL: Apa yang terjadi jika aktor "Tamu" iseng mengetikkan alamat anggota/tambah.html langsung di browser? (Sistem otorisasi harus menendang/redirect tamu tersebut kembali ke halaman Login).